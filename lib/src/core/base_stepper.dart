...
/// All steppers used by the package depend on this steppers functionality
class BaseStepper extends StatefulWidget {
  ...
  /// The border color of a step before it is reached.
...
class _BaseStepperState extends State<BaseStepper> {
  ...
  Widget _customizedIndicator(int index) {
    return BaseIndicator(
      ...
      inactiveBorderColor: widget.inactiveStepBorderColor,
      // inactiveBorderColor: widget.inactive,
